        ...
        >
          ...
          <div className="mt-auto pt-4 border-t border-gray-200 space-y-2">
            ...
            <a
              ...
              className="mt-3 inline-flex items-center justify-center w-full px-3 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 transition-colors"
            >
