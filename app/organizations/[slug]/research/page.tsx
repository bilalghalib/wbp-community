      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">
            Resources, reports, and documents shared by this organization
          </p>
        </div>
          ...
          <div className="bg-white rounded-lg shadow p-12 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">
              {searchParams.tag || searchParams.topic
                ...
                : isMember
                ? 'Be the first to share resources from your organization.'
                : 'This organization has not shared any resources yet.'}
            </p>
            {canUpload && (
              <div className="mt-6">
                <Link
